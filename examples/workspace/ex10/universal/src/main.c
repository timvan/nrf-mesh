...
static void initialise(void)
{
    ...
    __LOG(LOG_SRC_APP, LOG_LEVEL_INFO, "---------------------------------------------------------------------------------------------\n");
    __LOG(LOG_SRC_APP, LOG_LEVEL_INFO, "----- ex10 Multi Universal - GClients, GServers and Simple Server for each pin & HEALTH -----\n");
    __LOG(LOG_SRC_APP, LOG_LEVEL_INFO, "---------------------------------------------------------------------------------------------\n");
    ...
    m_health = mesh_stack_health_server_get();

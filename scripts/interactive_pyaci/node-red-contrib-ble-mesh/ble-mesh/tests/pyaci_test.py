...
class PyaciJsTest:
    ...
    def process_input(self):
        ...
        INPUT_LISTNERS = {
            ...
            "TestStatusEventGPIO": self.testStatusEventGPIO,
            "TestSetAckFailedEventGPIO": self.testSetAckFailedEventGPIO,
    ...
    def testStatusEventGPIO(self, data):
        op = "StatusEventGPIO"
        data = {
            "uuid": "FOOO",
            "pin": 17,
    ...
    def testSetAckFailedEventGPIO(self, data):
